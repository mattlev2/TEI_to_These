...
\usepackage[top=1.5cm, bottom=1.5cm, left=2cm,right=2cm, heightrounded, marginparwidth=2.5cm, marginparsep=0.8cm, includefoot]{geometry}
...
\newcommand{\legende}[1]{\begin{center}\LARGE\textbf{#1}\normalsize\end{center}}%Centrer une portion de texte, police moyenne
\newcommand{\auteur}[1]{\large \noindent #1 \normalsize}%crée une macro pour l'auteur (en haut à gauche de la page)
